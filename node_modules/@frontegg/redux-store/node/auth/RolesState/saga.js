...
function* addRoleV2(_ref2) {
  ...
  try {
    const role = yield (0, _effects.call)(_restApi.api.roles.addRoleV2, body);
    yield (0, _effects.put)(_reducer.actions.loadRolesAndPermissions({
      silentLoading: true
    }));
    callback == null ? void 0 : callback(role);
...
function* attachPermissionsToRole(_ref5) {
  let {
      payload: {
        callback
      }
...
function* rolesSagas() {
  ...
  yield (0, _effects.takeEvery)(_reducer.actions.addRoleV2, addRoleV2);
