...
declare const _default: {
    ...
    actions: {
        ...
        deletePhoneNumber: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("..").WithCallback<import("./SmsState/interfaces").IPhoneId, boolean>], import("..").WithCallback<import("./SmsState/interfaces").IPhoneId, boolean>, string, never, never>;
        verifyDeletePhoneNumber: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("..").WithCallback<import("./LoginState/interfaces").WithPhoneId<import("@frontegg/rest-api").IVerifyPhoneNumber>, boolean>], import("..").WithCallback<import("./LoginState/interfaces").WithPhoneId<import("@frontegg/rest-api").IVerifyPhoneNumber>, boolean>, string, never, never>;
        ...
        addRoleV2: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("..").WithCallback<import("@frontegg/rest-api").IAddRoleV2, import("@frontegg/rest-api").IRole>], import("..").WithCallback<import("@frontegg/rest-api").IAddRoleV2, import("@frontegg/rest-api").IRole>, string, never, never>;
        ...
        preDisableMfaWebAuthn: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("..").WithCallback<{
            deviceId: string;
        }, import("./LoginState/interfaces").IPreVerifyMFAWebAuthNForLoginResponse>], import("..").WithCallback<{
            deviceId: string;
        ...
        saveSSODomain: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("..").WithCallback<import("@frontegg/rest-api").ICreateSSODomain & {
            ssoConfigId: string;
        }, import("@frontegg/rest-api/auth/interfaces").ISSODomain>], import("..").WithCallback<import("@frontegg/rest-api").ICreateSSODomain & {
            ssoConfigId: string;
        ...
        verifyMFASMSForStepUp: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("..").WithCallback<import("./LoginState/interfaces").WithDeviceId<import("@frontegg/rest-api").IVerifyMFASMS>, boolean>], import("..").WithCallback<import("./LoginState/interfaces").WithDeviceId<import("@frontegg/rest-api").IVerifyMFASMS>, boolean>, string, never, never>;
        preVerifyMFAWebAuthnForStepUp: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("..").WithCallback<import("./LoginState/interfaces").WithDeviceId<import("@frontegg/rest-api").IPreVerifyMFA>, import("./LoginState/interfaces").IPreVerifyMFAWebAuthNForLoginResponse>], import("..").WithCallback<import("./LoginState/interfaces").WithDeviceId<import("@frontegg/rest-api").IPreVerifyMFA>, import("./LoginState/interfaces").IPreVerifyMFAWebAuthNForLoginResponse>, string, never, never>;
        verifyMFAWebAuthnForStepUp: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("./LoginState/interfaces").IVerifyMFAWebAuthnPayload], import("./LoginState/interfaces").IVerifyMFAWebAuthnPayload, string, never, never>;
        ...
        quickSmsPasswordlessPreLogin: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("..").WithCallback<import("./LoginState/interfaces").IQuickSmsPasswordlessPreLoginPayload, boolean>], import("..").WithCallback<import("./LoginState/interfaces").IQuickSmsPasswordlessPreLoginPayload, boolean>, string, never, never>;
        ...
        passwordlessPostLogin: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("..").WithCallback<import("./LoginState/interfaces").IPasswordlessPostLoginPayload, boolean>], import("..").WithCallback<import("./LoginState/interfaces").IPasswordlessPostLoginPayload, boolean>, string, never, never>;
        ...
        preVerifyMFAWebAuthnForLogin: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("..").WithCallback<import("./LoginState/interfaces").WithDeviceId<import("@frontegg/rest-api").IPreVerifyMFA>, import("./LoginState/interfaces").IPreVerifyMFAWebAuthNForLoginResponse>], import("..").WithCallback<import("./LoginState/interfaces").WithDeviceId<import("@frontegg/rest-api").IPreVerifyMFA>, import("./LoginState/interfaces").IPreVerifyMFAWebAuthNForLoginResponse>, string, never, never>;
        ...
        setSmsState: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[Partial<import("./SmsState/interfaces").SmsState>], Partial<import("./SmsState/interfaces").SmsState>, string, never, never>;
        ...
        setGroupsDialogsState: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[Partial<import("./GroupsState/interfaces").GroupsDialogsState>], Partial<import("./GroupsState/interfaces").GroupsDialogsState>, string, never, never>;
        ...
        openEditGroupDialog: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[Partial<import("./GroupsState/interfaces").EditGroupDialogState>], Partial<import("./GroupsState/interfaces").EditGroupDialogState>, string, never, never>;
        ...
        openDeleteMemberFromGroupDialog: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[Partial<import("./GroupsState/interfaces").DeleteMemberFromGroupDialogState>], Partial<import("./GroupsState/interfaces").DeleteMemberFromGroupDialogState>, string, never, never>;
        closeDeleteMemberFromGroupDialog: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<string>;
        setUsersGroupsLoader: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("./GroupsState/interfaces").GroupsStateIndicator], import("./GroupsState/interfaces").GroupsStateIndicator, string, never, never>;
        setUsersGroupsError: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("./GroupsState/interfaces").GroupsStateIndicator], import("./GroupsState/interfaces").GroupsStateIndicator, string, never, never>;
        setGroupsState: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[Partial<import("./GroupsState/interfaces").GroupsState>], Partial<import("./GroupsState/interfaces").GroupsState>, string, never, never>;
        ...
        setImpersonateState: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[Partial<import("./ImpersonationState/interfaces").ImpersonateState>], Partial<import("./ImpersonationState/interfaces").ImpersonateState>, string, never, never>;
        ...
        setStepUpState: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[Partial<import("./StepUpState/interfaces").StepUpState>], Partial<import("./StepUpState/interfaces").StepUpState>, string, never, never>;
